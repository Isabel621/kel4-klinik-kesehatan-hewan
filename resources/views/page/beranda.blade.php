...
<main>
  ...
  <div class="container marketing">
    ...
    <div class="row justify-content-center text-center" style="margin-top: 50px;">
        <div class="col-lg-4">
        <img src="../images/dok3.png" class="bd-placeholder-img rounded-circle" style="margin-bottom: 20px;"
        width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder"
        preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%"
        height="100%" fill="var(--bs-secondary-color)"></rect></img>
        ...
        <div class="col-lg-4">
            <img src="../images/dok4.png" class="bd-placeholder-img rounded-circle" style="margin-bottom: 20px;"
            width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder"
            preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%"
            height="100%" fill="var(--bs-secondary-color)"></rect></img>
      ...
      <div class="container-fluid rounded border-dark" id="mycontainer" style="padding: 30px;">
        ...
        <div>
          ...
          <p style="padding-left: 20px;">Dibangun secara tidak sengaja, karena banyak menemukan kucing-kucing yang
            tidak terawat diluar sana. Oleh karena itu dibangunlah klinik ini dengan harapan dapat membantu kucing
            yang butuh bantuan</p>
        </div>
      </div>
        ...
        <div class="col-md-6">
          ...
          <div class="paragraf col-md-6 mt-8">
            <div class="ms-auto">
              ...
              <!-- <p class="judul"></p> -->
              <p style="margin-top: 20px;">Menyediakan ruang tunggu bagi pengunjung saat hewan peliharaannya
                sedang ditangani oleh dokter.</p>
    ...
    <div class="row featurette">
        <div class="paragraf col-md-6">
            ...
            <p style="margin-top: 20px;">Anda dapat menitipkan kucing anda di penginapan kucing, apabila
                kucing anda perlu dirawat inap.</p>
            <button class="btn btn-primary btn-lg" id="button1">Selengkapnya >>></button>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <div class="paragraf col-md-6 mt-8">
            <div class="ms-auto">
              ...
              <!-- <p class="judul">siswa.</p> -->
              <p style="margin-top: 20px;">Kami menyediakan cafe yang nyaman untuk pelanggan yang
                ingin menghabiskan waktu sembari menunggu hewan peliharaan, tidak perlu khawatir merasa kebosanan!</p>
              <button class="btn btn-primary btn-lg" id="button1">Selengkapnya >>></button>
          </div>
    </div>
    ...
    <div class="row featurette">
        <div class="paragraf col-md-6">
            ...
            <!-- <p class="judul">siswa.</p> -->
            <p style="margin-top: 20px;">Menyediakan kebutuhan untuk kucing anda, dengan produk-produk
                yang sudah terjamin keamanannya.</p>
            <button class="btn btn-primary btn-lg" id="button1">Selengkapnya >>></button>
            </div>
        </div>
        <div class="col-md-6">
